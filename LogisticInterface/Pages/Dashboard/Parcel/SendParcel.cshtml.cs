...
{
    public class SendParcelModel : PageModel
    {

        private readonly LogisticDbContext _context;
        private readonly UserManager<AppUser> _userManager;

        public SendParcelModel(LogisticDbContext context, UserManager<AppUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync(string addressId)
        {
            ...
            if (addressId == null)
            {
                Parcel = await _context.Parcels.Where(p => p.SenderUserId == userId)
